...
---
a battery has a joltage of 1-9
batties are seperated into banks, rows of batteries
can turn on exactly two batteries per bank, jotlag of bank = turned on battery joltages values in order 12345,2,4 ( 24
joltage)
fine largest joltage of bank, sum all banks joltages
